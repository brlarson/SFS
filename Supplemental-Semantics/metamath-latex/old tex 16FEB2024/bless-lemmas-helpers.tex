...
\begin{restatable}{lemma}{blntwoimpor2}~\blTitle{bl.an2impor2}~ P and Q implies P or R.
\begin{align}
...
to a subset.
\begin{align}
\vdash \mc{A} \subseteq \mc{B}\quad\Rightarrow \notag \\ 
	\quad \vdash ( \forall \msc{x}
...
\vdash \mc{A} \in \mathbb{R}\quad\&\quad \vdash \mc{B} \in
    ...
    \mc{D} \in \mathbb{R}\quad\Rightarrow \notag \\ 
	\quad \vdash ( ( ( \mc{A} + \mc{B} ) +
...
\vdash \mc{A} \in \mathbb{R}\quad\&\quad \vdash \mc{B} \in
	...
	\quad
    \vdash ( \mc{A} \cdot ( \mc{B} + \mc{C} ) ) = ( ( \mc{A} \cdot \mc{B} ) + (
    \mc{A} \cdot \mc{C} ) )\label{eq:bl.adddii}\tag{bl.adddii}
\end{align}
\end{restatable}
...
\begin{align}
  ...
  \\ 10 &&  & \vdash ( \mc{A} \cdot ( \mc{B} + \mc{C} ) ) = ( ( \mc{A} \cdot
     ~\mc{B} ) + ( \mc{A} \cdot \mc{C} )
...
\vdash \mc{A} \in \mathbb{Z}\quad\&\quad \vdash \mc{B} \in
    \mathbb{Z}\quad\&\quad \vdash \mc{C} \in \mathbb{Z}\quad\Rightarrow \notag \\ 
	\quad
    \vdash ( \mc{A} \cdot ( \mc{B} + \mc{C} ) ) = ( ( \mc{A} \cdot \mc{B} ) + (
    \mc{A} \cdot \mc{C} ) )\label{eq:bl.adddizi}\tag{bl.adddizi}
\end{align}
\end{restatable}
