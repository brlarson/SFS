...
\pn A \texttt{Tangibility} library was created to embody the metaphysics described here: \ref{tangibility}.
...
fixed here to match the real source (df-pec above is stated correctly; this Lean field previously had the
