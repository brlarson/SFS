...
\texttt{OwnedFeatureTypedBy} (+\texttt{Exact}/\texttt{Star}/\texttt{Range}/\texttt{RangeStar})/
\texttt{MemberOf}/\texttt{OwnedFeatures}/\texttt{OrderedOn}/\texttt{OrderedDecl}/\texttt{ChainsDecl}/
