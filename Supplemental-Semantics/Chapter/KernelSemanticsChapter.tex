...
\begin{lstlisting}
  predicate starts {
    @Assert{n="starts"; f="<<starts : x~Occurrence, y~Occurrence : birth(x) = birth(y)"+
        " and death(y) < death(x) and x.openLeft = y.openLeft >>";}
...
\begin{lstlisting}
  predicate finishes {
    @Assert{n="finishes"; f="<<finishes : x~Occurrence, y~Occurrence : birth(y) < birth(x)"+
        " and death(x) = death(y) and x.openRight = y.openRight >>";}
...
\begin{lstlisting}
  predicate coincident {
    @Assert{n="coincident"; f="<<coincident : x~Occurrence, y~Occurrence : birth(y) = birth(x)"+
        " and death(x) = death(y) and x.openLeft = y.openLeft and x.openRight = y.openRight >>" ;}
...
\begin{lstlisting}
  predicate nearlyMeets {
    @Assert{n="nearlyMeets"; f="<<nearlyMeets : x~Occurrence, y~Occurrence :"+
      " birth(y) = death(x) and (x.openRight or y.openLeft)>>";}
