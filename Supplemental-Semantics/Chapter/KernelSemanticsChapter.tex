...
reasoning as \texttt{birth} above.

\texttt{\textcolor{leancolor}{axiom} \textcolor{leanyellow}{death} : Occurrence $\to$ Time}
\label{death}
\end{restatable}
...
\texttt{~~death A = t0 $\leftrightarrow$ existsAt A t0 $\wedge$ $\forall$ t1 : Time, t1.val $\in$ Set.Ioc t0.val now $\to$ $\lnot$ existsAt A t1}
\label{deathIff}
\end{restatable}
...
between \texttt{birth}'s and \texttt{death}'s own values.

\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{life} (A : Occurrence) : Set Instant := Set.Icc (birth A).val (death A).val}
\label{life}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{precedes} (A B : Occurrence) : Prop := (death A).val $\prec$ (birth B).val}
\label{precedes}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{meets} (A B : Occurrence) : Prop := death A = birth B}
\label{meets}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{overlaps} (A B : Occurrence) : Prop := (birth B).val $\prec$ (death A).val}
\label{overlaps}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{starts} (A B : Occurrence) : Prop := birth A = birth B $\wedge$ (death B).val $\prec$ (death A).val}
\label{starts}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{during} (A B : Occurrence) : Prop := (birth B).val $\preccurlyeq$ (birth A).val $\wedge$ (death A).val $\preccurlyeq$ (death B).val}
\label{during}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{finishes} (A B : Occurrence) : Prop := (birth B).val $\prec$ (birth A).val $\wedge$ death A = death B}
\label{finishes}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{coincident} (A B : Occurrence) : Prop := birth A = birth B $\wedge$ death A = death B}
\label{coincident}
\end{restatable}
...
\texttt{\textcolor{leancolor}{def} \textcolor{leanyellow}{nonoverlaps} (A B : Occurrence) : Prop := (death A).val $\prec$ (birth B).val $\vee$ (death B).val $\prec$ (birth A).val}
\label{nonoverlaps}
\end{restatable}
